...
mod platform {
    ...
    pub fn init_nspanel_plugin() -> tauri::plugin::TauriPlugin<tauri::Wry> {
        tauri_nspanel::init()
    }
}
...
// ── Public re-exports (platform-independent) ────────────────────────────
...
#[cfg(target_os = "macos")]
pub use platform::init_nspanel_plugin;

#[cfg(target_os = "macos")]
pub(crate) use platform::get_or_init_panel;

#[cfg(target_os = "macos")]
pub use platform::position_panel_at_tray_icon;
